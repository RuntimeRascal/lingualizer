...
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var locale, locDir, fileName, filePath, contents, json;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!argv.key || !argv.value) {
                    common_1.log(common_1.chalk.red('you must provide a valid key and value'));
                    return [2 /*return*/];
                }
            ...
            case 1:
                ...
                if (json == null) {
                    common_1.log("" + common_1.chalk.bgRedBright("unable to parse: '" + common_1.chalk.bgBlue(filePath) + "' to valid json object"));
                    return [2 /*return*/];
                }
