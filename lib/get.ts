...
import { getLocale, getFileName, IArgV, getLocalizationDirectory, chalk, terminalPrefix, log } from "./common";
...
export var handler = ( argv: IArgV ) =>
{
    ...
    if ( argv.key )
    {
        ...
        {
            log( `cannot find key ${ chalk.cyan( argv.key ) }` );
            return;
        }
